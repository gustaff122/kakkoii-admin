...
interface SeriesAutocompleteComponentState extends DefaultComponentState {
  series: Series[];
}

@Injectable()
export class SeriesAutocompleteComponentStore extends DefaultComponentStore<SeriesAutocompleteComponentState> {
